    ...
    <div class="container mt-3">
        <div class="row justify-content-center">
            <div class="col-6 text-center mb-5">
                <a href="{{ route('admin.list-products', ['id'=>12]) }}" class="btn btn-success">Kembali ke Halaman Admin</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="card border-dark border-3 mb-3 h-100">
                    <div class="card-body">
                        ...
                        @else
                            <p>Anda belum memiliki detail toko. <a href="{{ route('product.create') }}">Tambahkan sekarang</a></p>
                        @endif
                    </div>
                </div>
            </div>
