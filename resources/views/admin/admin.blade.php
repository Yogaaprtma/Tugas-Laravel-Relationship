    ...
    <div class="container mt-4">
        <div class="row w-100 bg-info rounded align-items-center px-3">
            ...
            <div class="col-auto ms-auto mt-2 mx-3">
                <a class="btn btn-primary fw-bold" data-bs-toggle="offcanvas" href="{{ route('profile.index', ['id'=>12])}}" role="button" aria-controls="offcanvasExample">Lihat Profil</a>
                <a class="btn btn-dark fw-bold" data-bs-toggle="offcanvas" href="{{ route('product.create', ['id'=>12]) }}" role="button" aria-controls="offcanvasExample">Tambah Produk</a>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('product.update', ['userId' => $userId, 'product' => $product->id]) }}" class="btn btn-warning me-1">Update</a>
                                     <form action="{{ route('product.delete', ['userId' => $userId, 'productId' => $product->id]) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
